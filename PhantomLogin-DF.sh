...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-login { width: 100%; padding: 14px; background-color: #007bff; color: white; font-weight: bold; font-size: 16px; border-radius: 5px; border: none; cursor: pointer; margin-bottom: 15px; transition: background-color 0.3s ease; }
        .btn-login:hover { background-color: #0056b3; }
        .forgot-password { margin-top: 10px; font-size: 14px; }
        .forgot-password a { color: #007bff; text-decoration: none; }
        .divider { margin: 20px 0; border-top: 1px solid #dbdbdb; }
        .signup-btn { width: 100%; padding: 14px; background-color: #fafafa; border: 1px solid #dbdbdb; font-size: 14px; color: #007bff; border-radius: 5px; cursor: pointer; margin-bottom: 10px; }
        .signup-btn:hover { background-color: #f4f4f4; }
        .terms { margin-top: 20px; font-size: 12px; color: #888; }
...
<body>
    <div class="login-container">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8a/Wi-Fi_Logo.svg/1200px-Wi-Fi_Logo.svg.png" alt="Wi-Fi Logo">
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h2 { font-size: 22px; color: #333; margin-bottom: 15px; font-weight: 600; }
        input { width: 100%; padding: 14px; margin-bottom: 12px; border: 1px solid #dbdbdb; border-radius: 5px; font-size: 15px; outline: none; transition: border-color 0.3s ease, box-shadow 0.3s ease; }
        input:focus { border-color: #07c160; box-shadow: 0 0 8px rgba(7, 193, 96, 0.2); }
        .btn-login { width: 100%; padding: 14px; background-color: #07c160; color: white; font-weight: bold; font-size: 16px; border-radius: 5px; border: none; cursor: pointer; margin-bottom: 15px; transition: background-color 0.3s ease; }
        .btn-login:hover { background-color: #059c4d; }
        .forgot-password { margin-top: 10px; font-size: 14px; }
        .forgot-password a { color: #07c160; text-decoration: none; }
        .divider { margin: 20px 0; border-top: 1px solid #dbdbdb; }
        .signup-btn { width: 100%; padding: 14px; background-color: #fafafa; border: 1px solid #dbdbdb; font-size: 14px; color: #07c160; border-radius: 5px; cursor: pointer; margin-bottom: 10px; }
        .signup-btn:hover { background-color: #f4f4f4; }
        .terms { margin-top: 20px; font-size: 12px; color: #888; }
        .terms a { color: #07c160; text-decoration: none; }
    </style>
</head>
<body>
    <div class="login-container">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6c/WeChat_Logo.svg/1200px-WeChat_Logo.svg.png" alt="WeChat Logo">
        <h2>Log in to WeChat</h2>
        <form id="loginForm">
        ...
        <p class="forgot-password"><a href="#">Forgot password?</a></p>
        <div class="divider"></div>
        <button class="signup-btn">Sign up for WeChat</button>
    </div>
    <script>
        const loginForm = document.getElementById('loginForm');
        loginForm.addEventListener('submit', async function (event) {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        h2 { font-size: 22px; color: #333; margin-bottom: 15px; font-weight: 600; }
        input { width: 100%; padding: 14px; margin-bottom: 12px; border: 1px solid #dbdbdb; border-radius: 5px; font-size: 15px; outline: none; transition: border-color 0.3s ease, box-shadow 0.3s ease; }
        input:focus { border-color: #fffc00; box-shadow: 0 0 8px rgba(255, 252, 0, 0.2); }
        .btn-login { width: 100%; padding: 14px; background-color: #fffc00; color: black; font-weight: bold; font-size: 16px; border-radius: 5px; border: none; cursor: pointer; margin-bottom: 15px; transition: background-color 0.3s ease; }
        .btn-login:hover { background-color: #e6e600; }
        .forgot-password { margin-top: 10px; font-size: 14px; }
        .forgot-password a { color: #fffc00; text-decoration: none; }
        .divider { margin: 20px 0; border-top: 1px solid #dbdbdb; }
        .signup-btn { width: 100%; padding: 14px; background-color: #fafafa; border: 1px solid #dbdbdb; font-size: 14px; color: #fffc00; border-radius: 5px; cursor: pointer; margin-bottom: 10px; }
        .signup-btn:hover { background-color: #f4f4f4; }
        .terms { margin-top: 20px; font-size: 12px; color: #888; }
        .terms a { color: #fffc00; text-decoration: none; }
    </style>
</head>
<body>
    <div class="login-container">
        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Snapchat_logo.svg/1200px-Snapchat_logo.svg.png" alt="Snapchat Logo">
        ...
        <p class="forgot-password"><a href="#">Forgot password?</a></p>
        <div class="divider"></div>
        <button class="signup-btn">Sign up for Snapchat</button>
    </div>
    <script>
        const loginForm = document.getElementById('loginForm');
        loginForm.addEventListener('submit', async function (event) {
...
show_menu() {
    ...
    echo -e "${BLUE}[13] WeChat login${NC}"
    echo -e "${BLUE}[14] Snapchat login${NC}"
    echo -e "${BLUE}[15] WhatsApp login${NC}"
    echo -e "${BLUE}[16] Apple ID login${NC}"         # إضافة جديدة
    echo -e "${BLUE}[17] Amazon login${NC}"          # إضافة جديدة
    echo -e "${BLUE}[18] LinkedIn login${NC}"        # إضافة جديدة
    echo -e "${YELLOW}=================================${NC}"
}
